...
function main() {
    require('./run_wasm')(wasmFile).then(async () => {
        ...
        // get address
        // params: p1 key, p2 id, random prim1, random prim2
        const keyGenMessage = keyGenRequestMessage(
            2,
            "",
            ""
        );
